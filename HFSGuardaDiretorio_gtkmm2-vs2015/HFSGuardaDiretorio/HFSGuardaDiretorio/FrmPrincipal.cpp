...
FrmPrincipal::FrmPrincipal()
	...
	menuGravarLogImportacao = manage(new class Gtk::CheckMenuItem());
...
void FrmPrincipal::on_notebook1_switch_page(GtkNotebookPage* page, guint page_num) {	
	if (frmPrincipal != NULL) {
