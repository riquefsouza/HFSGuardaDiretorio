...
Tabela::Tabela(bool bTabelaDir)
{
	...
	if (!bTabelaDir) {
		...
		colunaAba->set_sort_column_id(7);
	}
	...
	colunaCaminho->set_sort_column_id(6);
	...
	colunaAtributos->set_sort_column_id(5);
	...
	colunaModificado->set_sort_column_id(4);
	...
	colunaTipo->set_sort_column_id(3);
	...
	colunaTamanho->set_sort_column_id(2);
	...
	colunaNome->set_sort_column_id(1);
