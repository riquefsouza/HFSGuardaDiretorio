...
public class FrmPrincipal {
	...
	protected void createContents() {
		...
		btnImportarDiretorio.setBounds(0, 0, 75, 25);
		FormData fd_btnImportarDiretorio = new FormData();
		fd_btnImportarDiretorio.right = new FormAttachment(0, 109);
		...
		fd_barraStatus1.right = new FormAttachment(0, 300);
		...
		fd_barraStatus2.left = new FormAttachment(0, 300);
