    ...
    wxDialog( parent, wxID_ANY, wxT("Sobre o Catalogador"), wxDefaultPosition, wxSize( 457,179 ), wxDEFAULT_DIALOG_STYLE )
{
	...
	m_staticText1->SetFont( wxFont( 14, 70, 90, 92, false, wxEmptyString ) );
	...
	m_staticText4 = new wxStaticText( this, wxID_ANY, wxT("Todos os direitos reservados, 2014"), wxDefaultPosition, wxDefaultSize, 0 );
