...
public:
	...
	static int cPos(const char* subtexto, const char* texto);
	...
	static int cLastDelimiter(const char* sub, const char* texto);
	static char* cStrndup(const char* texto, size_t tamanho);
	static char* cSubString(const char* texto, int inicio, int tamanho);
...
// ---------------------------------------------------------------------------
	...
	static long BlobLoadFromFile(const std::string &sNomeArquivo, void** blob);
	// ---------------------------------------------------------------------------
	...
	static ImagemBuffer BlobToPixbuf(const void* blob, int tamanho);
	static int PixbufToBlob(ImagemBuffer pixbuf, void** blob, const std::string &formato);
