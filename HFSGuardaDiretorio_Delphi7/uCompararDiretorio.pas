...
uses
  Windows, Messages, SysUtils, Variants, Classes, uListadiretorio, Graphics,
  Controls, Forms, Dialogs, ComCtrls, StdCtrls, ExtCtrls, uDiretorio, uListaAba,
  uAba, uRotinas;
...
type
  ...
  private
    ...
    function SQLCompara(aba1, aba2: TAba; 
...
procedure TFrmCompararDiretorio.Comparar(sCaminhoDir1: string; sCaminhoDir2: string);
var
  sSQL: String;
  aba1: TAba;
  aba2: TAba;
begin
  ...
  carregarDiretorio(sSQL, listaCompara, ProgressoLog);
