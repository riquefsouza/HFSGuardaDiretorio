...
begin
  ...
  tvLocal.OnCollapsed:=@tvFixaCollapsed;
  tvLocal.OnExpanded:=@tvFixaExpanded;
...
begin
  ...
  if sdExportar.Execute then begin
    if FileExistsUTF8(sdExportar.FileName) then
...
begin
  if odImportar.Execute then begin
    if not FileExistsUTF8(odImportar.FileName) then
