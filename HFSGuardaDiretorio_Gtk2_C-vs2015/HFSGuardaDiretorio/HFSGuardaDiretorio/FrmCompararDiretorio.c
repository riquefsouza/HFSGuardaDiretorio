...
GtkWidget *FrmCompararDiretorio_Criar()
{
	...
	gtk_statusbar_set_has_resize_grip(GTK_STATUSBAR(FrmCompararDiretorio.barraStatus11), FALSE);
	...
	FrmCompararDiretorio.cmbAba2 = gtk_combo_box_new_text();
	...
	gtk_widget_set_name(GTK_WIDGET(FrmCompararDiretorio.alignment2), "alignment2");
	gtk_widget_set_visible(FrmCompararDiretorio.alignment2, TRUE);
	gtk_widget_set_can_focus(FrmCompararDiretorio.alignment2, FALSE);
	gtk_alignment_set_padding(GTK_ALIGNMENT(FrmCompararDiretorio.alignment2), 0, 0, 12, 0);
	gtk_container_add(GTK_CONTAINER(FrmCompararDiretorio.alignment2), FrmCompararDiretorio.vbox7);
	...
	gtk_container_add(GTK_CONTAINER(FrmCompararDiretorio.frame3), FrmCompararDiretorio.alignment2);
	...
	FrmCompararDiretorio.cmbAba1 = gtk_combo_box_new_text();
	...
	gtk_widget_set_name(GTK_WIDGET(FrmCompararDiretorio.alignment1), "alignment1");
	gtk_widget_set_visible(FrmCompararDiretorio.alignment1, TRUE);
	gtk_widget_set_can_focus(FrmCompararDiretorio.alignment1, FALSE);
	gtk_alignment_set_padding(GTK_ALIGNMENT(FrmCompararDiretorio.alignment1), 0, 0, 12, 0);
	gtk_container_add(GTK_CONTAINER(FrmCompararDiretorio.alignment1), FrmCompararDiretorio.vbox6);
	...
	gtk_container_add(GTK_CONTAINER(FrmCompararDiretorio.frame2), FrmCompararDiretorio.alignment1);
	...
	g_signal_connect((gpointer) FrmCompararDiretorio.btnCompararDiretorios, "clicked", G_CALLBACK(on_btnCompararDiretorios_clicked), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.btnSalvarLog, "clicked", G_CALLBACK(btnSalvarLog_clicked_cb), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.cmbAba1, "changed", G_CALLBACK(on_cmbAba1_changed), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio1, "row_collapsed", G_CALLBACK(on_tvDiretorio1_row_collapsed), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio1, "row_expanded", G_CALLBACK(on_tvDiretorio1_row_expanded), NULL);
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio1, "button_release_event", G_CALLBACK(on_tvDiretorio1_button_release_event), NULL);
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio1, "button_press_event", G_CALLBACK(on_tvDiretorio1_button_press_event), NULL);

	g_signal_connect((gpointer) FrmCompararDiretorio.cmbAba2, "changed", G_CALLBACK(on_cmbAba2_changed), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio2, "row_collapsed", G_CALLBACK(on_tvDiretorio2_row_collapsed), NULL);
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio2, "row_expanded", G_CALLBACK(on_tvDiretorio2_row_expanded), NULL);
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio2, "button_release_event", G_CALLBACK(on_tvDiretorio2_button_release_event), NULL);
	g_signal_connect((gpointer) FrmCompararDiretorio.tvDiretorio2, "button_press_event", G_CALLBACK(on_tvDiretorio2_button_press_event), NULL);

	g_signal_connect((gpointer) FrmCompararDiretorio.tabelaCompara, "row_activated", G_CALLBACK(on_tabelaCompara_row_activated), NULL); 
	g_signal_connect((gpointer) FrmCompararDiretorio.tabelaCompara, "button_release_event", G_CALLBACK(on_tabelaCompara_button_release_event), NULL);
			
	g_signal_connect ((gpointer) FrmCompararDiretorio.frmCompararDiretorio, "destroy", 
...
// ---------------------------------------------------------------------------
void on_FrmCompararDiretorio_destroy(GtkObject *object, gpointer user_data) {
...
void on_btnCompararDiretorios_clicked(GtkObject *object, gpointer user_data){
...
void btnSalvarLog_clicked_cb(GtkObject *object, gpointer user_data){
	GString* sLog;
...
void on_cmbAba1_changed(GtkObject *object, gpointer user_data){
	Aba aba = Aba_new();

	gdk_window_set_cursor(GDK_WINDOW(FrmCompararDiretorio.frmCompararDiretorio), 
...
void on_cmbAba2_changed(GtkObject *object, gpointer user_data){
	Aba aba = Aba_new();
...
void FrmCompararDiretorio_CarregarDados() {
	...
	for (unsigned int i = 0; i < tamlista; i++) {
		...
		gtk_combo_box_append_text(GTK_COMBO_BOX(FrmCompararDiretorio.cmbAba1), aba->nome->str);
		gtk_combo_box_append_text(GTK_COMBO_BOX(FrmCompararDiretorio.cmbAba2), aba->nome->str);
	}
