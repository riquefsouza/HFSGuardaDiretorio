...
GtkWidget *FrmInfoDiretorio_Criar()
{
	...
	gtk_button_set_label(GTK_BUTTON(FrmInfoDiretorio.btnOk), "gtk-ok");
	...
	gtk_button_set_use_stock(GTK_BUTTON(FrmInfoDiretorio.btnOk), TRUE);
	...
	PangoContext* pc = gtk_widget_get_pango_context(GTK_WIDGET(rtexto));
	pango_context_set_font_description(pc, pfd);
	//gtk_widget_modify_font(GTK_WIDGET(rtexto), pfd);
	...
	gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(FrmInfoDiretorio.scrollTabela1), GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
	...
	gtk_widget_set_name(GTK_WIDGET(FrmInfoDiretorio.table1), "table1");
	gtk_widget_set_visible(FrmInfoDiretorio.table1, TRUE);
	gtk_widget_set_can_focus(FrmInfoDiretorio.table1, FALSE);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labArquivoComum, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 5, 5);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labArquivoOculto, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 5, 5);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labArquivoSistema, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 5, 5);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labLegendaDiretorio, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 5, 5);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labVolumeID, 0, 1, 2, 3, GTK_FILL, GTK_FILL, 5, 5);
	gtk_table_attach(GTK_TABLE(FrmInfoDiretorio.table1), FrmInfoDiretorio.labArquivoSomenteLeitura, 1, 2, 2, 3, GTK_FILL, GTK_FILL, 5, 5);
	...
	gtk_container_add(GTK_CONTAINER(FrmInfoDiretorio.frame1), FrmInfoDiretorio.table1);
	...
	gtk_widget_set_size_request(FrmInfoDiretorio.frmInfoDiretorio, 385, 329);
	...
	g_signal_connect((gpointer) FrmInfoDiretorio.btnOk, "clicked", G_CALLBACK(on_btnOk_clicked), NULL); 			
	g_signal_connect ((gpointer) FrmInfoDiretorio.frmInfoDiretorio, "destroy", 
...
// ---------------------------------------------------------------------------
void on_FrmInfoDiretorio_destroy(GtkObject *object, gpointer user_data) {
	
}
// ---------------------------------------------------------------------------
void on_btnOk_clicked(GtkObject *object, gpointer user_data){
	gtk_widget_destroy(FrmInfoDiretorio.frmInfoDiretorio);
}
