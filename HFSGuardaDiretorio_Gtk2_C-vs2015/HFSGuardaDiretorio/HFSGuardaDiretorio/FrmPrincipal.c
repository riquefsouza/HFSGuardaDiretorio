...
GtkWidget *FrmPrincipal_Criar()
{
	...
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuSobre), FrmPrincipal.menuSobreCatalogador);
	...
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuVisao), FrmPrincipal.menuMostrarOcultarArvoreDirAbaAtiva);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuVisao), FrmPrincipal.menuMostrarOcultarListaItensPesquisados);
	...
	gtk_menu_append(GTK_MENU(FrmPrincipal.menu2), FrmPrincipal.menuTXT);
	gtk_menu_append(GTK_MENU(FrmPrincipal.menu2), FrmPrincipal.menuCSV);
	gtk_menu_append(GTK_MENU(FrmPrincipal.menu2), FrmPrincipal.menuHTML);
	gtk_menu_append(GTK_MENU(FrmPrincipal.menu2), FrmPrincipal.menuXML);
	gtk_menu_append(GTK_MENU(FrmPrincipal.menu2), FrmPrincipal.menuSQL);
	...
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuImportarDiretorio);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuImportarSubDiretorios);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuCompararDiretorios);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuCadastrarExtensaoArquivo);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuseparador1);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuExpandirDiretorios);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuColapsarDiretorios);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuExportarDiretoriosAbaAtiva);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuImportarDiretoriosViaXML);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuDiretorio), FrmPrincipal.menuGravarLogImportacao);
	...
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuAba), FrmPrincipal.menuIncluirNovaAba);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuAba), FrmPrincipal.menuAlterarNomeAbaAtiva);
	gtk_menu_append(GTK_MENU(FrmPrincipal.submenuAba), FrmPrincipal.menuExcluirAbaAtiva);
	...
	gtk_menu_bar_append(GTK_MENU_BAR(FrmPrincipal.barraMenu1), FrmPrincipal.menuAba);
	gtk_menu_bar_append(GTK_MENU_BAR(FrmPrincipal.barraMenu1), FrmPrincipal.menuDiretorio);
	gtk_menu_bar_append(GTK_MENU_BAR(FrmPrincipal.barraMenu1), FrmPrincipal.menuVisao);
	gtk_menu_bar_append(GTK_MENU_BAR(FrmPrincipal.barraMenu1), FrmPrincipal.menuSobre);
	...
	gtk_widget_set_size_request(FrmPrincipal.frmPrincipal, 900, 500);
	...
	gtk_window_set_default_size(GTK_WINDOW(FrmPrincipal.frmPrincipal), 950, 718);
	...
	FrmPrincipal_adicionaTabPage(GTK_NOTEBOOK(FrmPrincipal.notebook1), GTK_HPANED(FrmPrincipal.sp), g_string_new("DISCO1"));
...
GtkLabel* FrmPrincipal_getLabStatus2() {
 ...
 void FrmPrincipal_ConstruirPopupMenu() {
	 ...
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuInformacoesDiretorioArquivo);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuExcluirDiretorioSelecionado);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuExpandirDiretorios2);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuColapsarDiretorios2);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuseparador2);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuIncluirNovaAba2);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuAlterarNomeAbaAtiva2);
	 gtk_menu_append(GTK_MENU(FrmPrincipal.popupMenu), FrmPrincipal.menuExcluirAbaAtiva2);

	 g_signal_connect((gpointer)FrmPrincipal.menuInformacoesDiretorioArquivo, "activate", G_CALLBACK(FrmPrincipal_menuInformacoesDiretorioArquivo_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuExcluirDiretorioSelecionado, "activate", G_CALLBACK(FrmPrincipal_menuExcluirDiretorioSelecionado_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuExpandirDiretorios2, "activate", G_CALLBACK(FrmPrincipal_menuExpandirDiretorios2_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuColapsarDiretorios2, "activate", G_CALLBACK(FrmPrincipal_menuColapsarDiretorios2_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuIncluirNovaAba2, "activate", G_CALLBACK(FrmPrincipal_menuIncluirNovaAba2_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuAlterarNomeAbaAtiva2, "activate", G_CALLBACK(FrmPrincipal_menuAlterarNomeAbaAtiva2_activate), NULL);
	 g_signal_connect((gpointer)FrmPrincipal.menuExcluirAbaAtiva2, "activate", G_CALLBACK(FrmPrincipal_menuExcluirAbaAtiva2_activate), NULL);
...
void on_btnImportarDiretorio_clicked(GtkObject *object, gpointer user_data){
	on_menuImportarDiretorio_activate(object, user_data);
}
