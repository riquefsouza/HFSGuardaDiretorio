...
GtkWidget *FrmCadExtensao_Criar()
{
	...
	gtk_button_set_label(GTK_BUTTON(FrmCadExtensao.btnExcluir), "gtk-remove");
	...
	gtk_button_set_use_stock(GTK_BUTTON(FrmCadExtensao.btnExcluir), TRUE);
	
	FrmCadExtensao.btnIncluir = gtk_button_new();
	gtk_widget_set_name(GTK_WIDGET(FrmCadExtensao.btnIncluir), "btnIncluir");
	gtk_button_set_label(GTK_BUTTON(FrmCadExtensao.btnIncluir), "gtk-add");
	...
	gtk_button_set_use_stock(GTK_BUTTON(FrmCadExtensao.btnIncluir), TRUE);
	...
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuImportarTodos), FrmCadExtensao.menuImportarIconesArquivos);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuImportarTodos), FrmCadExtensao.menuExtrairIconesArquivos);
	...
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarBitmap);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarIcone);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarGIF);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarJPEG);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarPNG);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExportarTodos), FrmCadExtensao.menuExportarTIFF);
	...
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExtensao), FrmCadExtensao.menuIncluirExtensao);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExtensao), FrmCadExtensao.menuExcluirExtensao);
	gtk_menu_append(GTK_MENU(FrmCadExtensao.submenuExtensao), FrmCadExtensao.menuExcluirTodasExtensoes);
	...
	gtk_menu_bar_append(GTK_MENU_BAR(FrmCadExtensao.barraMenu), FrmCadExtensao.menuExtensao);
	gtk_menu_bar_append(GTK_MENU_BAR(FrmCadExtensao.barraMenu), FrmCadExtensao.menuExportarTodos);
	gtk_menu_bar_append(GTK_MENU_BAR(FrmCadExtensao.barraMenu), FrmCadExtensao.menuImportarTodos);
	...
	g_signal_connect((gpointer) FrmCadExtensao.menuIncluirExtensao, "activate", G_CALLBACK(on_menuIncluirExtensao_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExcluirExtensao, "activate", G_CALLBACK(on_menuExcluirExtensao_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExcluirTodasExtensoes, "activate", G_CALLBACK(on_menuExcluirTodasExtensoes_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarBitmap, "activate", G_CALLBACK(on_menuExportarBitmap_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarIcone, "activate", G_CALLBACK(on_menuExportarIcone_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarGIF, "activate", G_CALLBACK(on_menuExportarGIF_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarJPEG, "activate", G_CALLBACK(on_menuExportarJPEG_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarPNG, "activate", G_CALLBACK(on_menuExportarPNG_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExportarTIFF, "activate", G_CALLBACK(on_menuExportarTIFF_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuImportarIconesArquivos, "activate", G_CALLBACK(on_menuImportarIconesArquivos_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.menuExtrairIconesArquivos, "activate", G_CALLBACK(on_menuExtrairIconesArquivos_activate), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.btnIncluir, "clicked", G_CALLBACK(on_btnIncluir_clicked), NULL); 
	g_signal_connect((gpointer) FrmCadExtensao.btnExcluir, "clicked", G_CALLBACK(on_btnExcluir_clicked), NULL); 

		
	g_signal_connect ((gpointer) FrmCadExtensao.frmCadExtensao, "destroy", 
...
void on_btnIncluir_clicked(GtkObject *object, gpointer user_data){
	on_menuIncluirExtensao_activate(object, user_data);
}

void on_btnExcluir_clicked(GtkObject *object, gpointer user_data){
	on_menuExcluirExtensao_activate(object, user_data);
}
