...
namespace HFSGuardaDiretorio.comum
{
	...
	public static class Rotinas
	{
		...
		public static double calculaProgresso(int nMaximo, int nProgresso){
			nMaximo += 1;
			nProgresso += 1;
		...
		public static Gdk.Pixbuf byteArrayToPixbuf(byte[] byteArrayIn)
		{
			Gdk.Pixbuf pxb = new Gdk.Pixbuf(byteArrayIn);
			return pxb;
		}
