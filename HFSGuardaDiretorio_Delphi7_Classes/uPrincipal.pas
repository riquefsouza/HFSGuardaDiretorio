...
type
  TFrmPrincipal = class(TForm)
    ...
    LegendaAtributos1: TMenuItem;
    Arquivocomum1: TMenuItem;
    ArquivoOculto1: TMenuItem;
    ArquivodeSistema1: TMenuItem;
    Diretorio2: TMenuItem;
    VolumeID1: TMenuItem;
    ArquivoSomenteLeitura1: TMenuItem;
  ...
  private
    ...
    procedure ExcluirDados(aba: TAbaObjeto; sCaminho: String);
...
procedure TFrmPrincipal.ExcluirDados(aba: TAbaObjeto; sCaminho: String);
begin
...
begin
  ...
  begin
    importar:=TImportarObjeto.Create;
