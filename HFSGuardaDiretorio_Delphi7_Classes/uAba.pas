...
uses
Classes, SysUtils, StrUtils, ComCtrls, DB, uDataModule, uAbaObjeto, uListaAba,
uRotinas;
...
type
  ...
  public
    ...
    function pegaAbaPorOrdem(lista: TListaAba; ordem: Integer): TAbaObjeto;
  end;
...
function TAba.pegaAbaPorOrdem(lista: TListaAba; ordem: Integer): TAbaObjeto;
var i: integer;
 aba: TAbaObjeto;
begin
  result:=nil;
