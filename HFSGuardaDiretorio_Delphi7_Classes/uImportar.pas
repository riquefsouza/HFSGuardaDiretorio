...
uses
  Classes, SysUtils, StrUtils, uImportarObjeto, uRotinas,
  uListaDiretorio, uListaImportar, uListaExtensao,
  ComCtrls, uArquivo, uDiretorio, uExtensao;
...
procedure TImportar.CarregarListaDiretorios(importar: TImportarObjeto; var nOrdem: integer;
   listaDiretorio: TListaDiretorio; log: TStrings);
var
  arquivo: TArquivo;
...
procedure TImportar.ImportacaoCompleta(importar: TImportarObjeto; var nOrdem: integer;
  listaExtensao: TListaExtensao; log: TStrings; progressoLog: TProgressoLog);
var
