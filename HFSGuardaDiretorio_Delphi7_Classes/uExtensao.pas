...
uses
  Classes, SysUtils, StrUtils, uExtensaoObjeto, uListaExtensao, uListaDiretorio,
  ComCtrls, DB, uDataModule, Graphics, Controls, uDiretorio, uDiretorioObjeto, 
...
procedure TExtensao.carregarExtensao(listaExtensao: TListaExtensao; progressoLog: TProgressoLog);
var
  Extensao: TExtensao;
  i, total: integer;
...
function TExtensao.pegaExtensaoPorOrdem(lista: TListaExtensao; ordem: Integer):
  TExtensaoObjeto;
var i: integer;
 extensao: TExtensaoObjeto;
begin
