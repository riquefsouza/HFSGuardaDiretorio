...
uses
 Classes, SysUtils, StrUtils, uDiretorioObjeto, uListaDiretorio, uListaAba,
  ComCtrls, uDataModule, DB, SQLiteTable3, uAbaObjeto,
...
type
  ...
  public
    ...
    function excluirDiretorio(aba: TAbaObjeto; sCaminho: String):boolean;
    procedure excluirListaDiretorio(listaDiretorio: TListaDiretorio;
      aba: TAbaObjeto; sCaminho: String);
    ...
    procedure exportarDiretorio(tipo: TTipoExportar; aba: TAbaObjeto;
      sNomeArquivo :String; progressoLog: TProgressoLog);
    function criarTabelaDiretorios:boolean;
    function importarDiretorioViaXML(aba: TAbaObjeto; sNomeArquivo:String;
...
function TDiretorio.itensFilhos(lista_pai: TListaDiretorio; aba, codDirPai, codigo: integer)
  : TListaDiretorio;
var
...
function TDiretorio.excluirDiretorio(aba: TAbaObjeto; sCaminho: String):boolean;
var sSQL: string;
begin
...
procedure TDiretorio.exportarDiretorio(tipo: TTipoExportar; aba: TAbaObjeto;
  sNomeArquivo :String; progressoLog: TProgressoLog);
...
function TDiretorio.importarDiretorioViaXML(aba: TAbaObjeto; sNomeArquivo:String;
  listaDirPai: TListaDiretorio; log: TStrings; progressoLog: TProgressoLog): integer;
