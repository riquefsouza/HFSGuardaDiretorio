...
begin
  try
    ...
    begin
      ...
      begin
        ...
        ImportacaoCompleta(importar, FrmPrincipal.nGlobalOrdem,
      ...
      begin
        if not verificaCodDir(importar.aba, importar.rotuloRaiz,
          FrmPrincipal.listaDiretorioPai) then
        begin
          screen.Cursor := crHourGlass;
  ...
  if FrmPrincipal.GravarLogImportacao1.Checked then
  begin
    if memoImportaDir.Lines.Count > 0 then
    begin
