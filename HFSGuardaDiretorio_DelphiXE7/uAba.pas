  ...
  begin
    ...
    begin
      ...
      begin
        ...
        {
          codigo := StrToInt(dm.tabelaAbas.FieldAsString(dm.tabelaAbas.FieldIndex['cod']));  //0
...
function abaToSQL(aba: TAba): String;
begin
  result := 'insert into Abas(cod, nome) values(' + inttostr(aba.codigo) + ',' +
    QuotedStr(aba.nome) + ')';
end;
...
var
  sSQL: string;
begin
  sSQL := 'create table IF NOT EXISTS Abas(' + 'cod integer not null,' +
    'nome varchar(10) not null,' + 'primary key (cod))';
