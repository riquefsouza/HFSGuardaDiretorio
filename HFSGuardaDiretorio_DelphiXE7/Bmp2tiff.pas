...
{$ENDIF}
  ...
  TifHeader: array [0 .. 7] of Byte = (
    ...
    $00,
    $00
  ); { Pointer to the first directory }
  ...
  NullString: array [0 .. 3] of Byte = (
    $00,
    $00,
    $00,
    $00
  );
  X_Res_Value: array [0 .. 7] of Byte = (
    $6D,
    $03,
    $00,
    $00,
  ...
  BitsPerSample: array [0 .. 2] of Word = (
    $0008,
    $0008,
    $0008
  );
