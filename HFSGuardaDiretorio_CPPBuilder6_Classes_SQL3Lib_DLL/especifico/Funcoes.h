...
//---------------------------------------------------------------------------
static inline int cLastIndexOf(const char* texto, char alvo)
{
	int retorno = -1;
...
//---------------------------------------------------------------------------
static inline std::string cppTrimLeft(std::string texto)
{
...
//---------------------------------------------------------------------------
static inline std::string cppTrimRight(std::string texto)
{
	texto.erase(std::find_if(texto.rbegin(), texto.rend(),
							 std::not1(std::ptr_fun<int, int>(std::isspace))).base(), texto.end());
	return texto;
}
//---------------------------------------------------------------------------
static inline std::string cppTrim(std::string texto)
{
	return cppTrimLeft(cppTrimRight(texto));
}
//---------------------------------------------------------------------------
static inline std::string cppLowerCase(std::string texto)
{
	std::transform(texto.begin(), texto.end(), texto.begin(), ::tolower);
	return texto;
}
//---------------------------------------------------------------------------
static inline std::string cppUpperCase(std::string texto)
{
	std::transform(texto.begin(), texto.end(), texto.begin(), ::toupper);
	return texto;
}
//---------------------------------------------------------------------------
static inline int cppPos(std::string sub, std::string texto)
{
...
//---------------------------------------------------------------------------
static inline int cppLastDelimiter(std::string sub, std::string texto)
{
...
//---------------------------------------------------------------------------
static inline std::string cppSubString(std::string texto, int inicio, int tamanho)
{
...
//---------------------------------------------------------------------------
static inline std::string cppQuotedStr(std::string texto)
{
	std::stringstream ss;
	ss << "'" << texto << "'";
	return ss.str();
...
//---------------------------------------------------------------------------
static inline std::string cppStringReplaceAll(std::string texto,
        const std::string velho, const std::string novo)
{
    size_t pos = 0;
    while ((pos = texto.find(velho, pos)) != std::string::npos)
    {
        texto.replace(pos, velho.length(), novo);
        pos += novo.length();
    }
    return texto;
}
