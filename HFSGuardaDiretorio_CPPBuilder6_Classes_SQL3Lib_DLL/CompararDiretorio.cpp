...
void TFrmCompararDiretorio::Comparar(String sCaminhoDir1, String sCaminhoDir2) {
	...
	//Diretorio->carregarDiretorio(dm->consultaAuxiliar, listaCompara,
	  //FrmCompararDiretorio_ProgressoLog);

	sSQL = SQLCompara(aba1, aba2, sCaminhoDir1, sCaminhoDir2);
	Diretorio->carregarDiretorio(sSQL, listaCompara,
		ProgressoLog);
...
// ---------------------------------------------------------------------------
void __fastcall TFrmCompararDiretorio::lvComparaColumnClick(
...
void __fastcall TFrmCompararDiretorio::lvComparaCompare(TObject *Sender,
