...
__published: // IDE-managed Components
	...
	void __fastcall InformacoesDiretorioArquivo1Click(TObject *Sender);
        void __fastcall lvFixaColumnClick(TObject *Sender,
          TListColumn *Column);
        void __fastcall lvFixaCompare(TObject *Sender, TListItem *Item1,
          TListItem *Item2, int Data, int &Compare);
        void __fastcall lvPesquisaColumnClick(TObject *Sender,
          TListColumn *Column);
        void __fastcall lvPesquisaCompare(TObject *Sender,
          TListItem *Item1, TListItem *Item2, int Data, int &Compare);
        void __fastcall tvFixaCollapsed(TObject *Sender, TTreeNode *Node);
        void __fastcall tvFixaExpanded(TObject *Sender, TTreeNode *Node);
